...
def add_base_options(parser):
    ...
    group.add_argument("--debug", type=str, default=0)
...
def add_data_options(parser):
    ...
    group.add_argument("--dataset", default='interact', type=str,
                       help="Dataset name (choose from list).")
    group.add_argument("--obj_split", action='store_true',
                       help="If True, will use objects to split dataset.")
...
def add_training_options(parser):
    ...
    group.add_argument("--save_dir", required=True, type=str,
                       help="Path to save checkpoints and results.")
    group.add_argument("--use_fp16",  type=int, default=0,
                       help="Path to save checkpoints and results.")
    group.add_argument("--fp16_scale_growth",  type=float,default=1e-3,
                       help="Path to save checkpoints and results.")
    ...
    group.add_argument("--num_steps", default=1600_000, type=int,
...
def add_obj_options(parser):
    ...
    group.add_argument("--pretrained_path", default='./save/interact_200000/model000200000.pt', type=str,
...
def get_cond_mode(args):
    if args.unconstrained:
        cond_mode = 'no_cond'
    elif args.dataset.startswith('interact') or args.dataset in ['behave', 'intercap', 'neuraldome', 'chairs', 'omomo', 'imhd', 'grab', 'interact','interact_wobehave','interact_wobehave_correct']:
        cond_mode = 'text'
    else:
        cond_mode = 'action'
    return cond_mode
