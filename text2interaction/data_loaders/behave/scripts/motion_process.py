...
def get_human_representation(positions, feet_thre, fid_l, fid_r):
    ...
    def foot_detect(positions, thres):
        velfactor, heightfactor = thres, 0.1
    ...
    positions = positions.reshape(len(positions), -1)
    data = np.concatenate([positions[:-1], velocity, feet_l, feet_r], axis=-1)
    return data
