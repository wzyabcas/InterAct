...
##joint_dict = {
#     'C7': '第七颈椎','CLAV': '锁骨','LANK': '左踝','LASI': '左髂前上棘','LBAK': '左肩胛下角',
#     'LBCEP': '左肱二头肌','LBHD': '左肩胛骨','LBUM': '左臀部','LBUST': '左胸部',LCHEECK': '左腮','LELB': '左肘',
#     'LELBIN': '左肘内侧','LFHD': '左脸部','LFIN': '左手指','LFRM': '左前臂','LFTHIIN': '左大腿内侧','LHEE': '左脚后跟',
#     'LIWR': '左腕','LKNE': '左膝盖','LKNI': '左膝内侧','LMT1': '左中足骨头1', 'LMT5': '左中足骨头5','LNWST': '左腕部',
#     'LOWR': '左下腹部','LPSI': '左骶前上棘','LRSTBEEF': '左肋骨下','LSCAP': '左肩胛骨','LSHN': '左肩',
#     'LSHO': '左肩','LTHI': '左大腿','LTHILO': '左大腿内侧','LTHMB': '左拇指','LTOE': '左脚趾','MBLLY': '脐部', 'RANK': '右踝',
#     'RASI': '右髂前上棘','RBAK': '右肩胛下角','RBCEP': '右肱二头肌','RBHD': '右肩胛骨', 'RBSH': '右肩胛骨','RBUM': '右臀部',
#     'RBUST': '右胸部','RCHEECK': '右腮','RELB': '右肘','RELBIN': '右肘内侧','RFHD': '右脸部','RFIN': '右手指',
#     'RFRM2': '右前臂','RFTHI': '右大腿','RFTHIIN': '右大腿内侧','RHEE': '右脚后跟','RIWR': '右腕','RKNE': '右膝盖',
#     'RKNI': '右膝内侧','RMT1': '右中足骨头1','RMT5': '右中足骨头5','RNWST': '右腕部','ROWR': '右下腹部','RPSI': '右骶前上棘',
#     'RRSTBEEF': '右肋骨下','RSHO': '右肩','RTHI': '右大腿','RTHMB': '右拇指','RTIB': '右胫骨','RTOE': '右脚趾',
#     'STRN': '胸骨','T8': '第八胸椎'
# }
...
marker2bodypart = {
    ...
    "left__ids": [29, 30, 18, 19, 7, 2, 15],
    "right_foot_footids": [61, 52, 53, 40, 34, 49, 40],
