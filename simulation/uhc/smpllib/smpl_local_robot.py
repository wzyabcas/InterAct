...
def update_joint_limits(joint_range):
    joint_range["Head"][0] = np.array([-np.pi, np.pi])
    joint_range["Head"][1] = np.array([-np.pi, np.pi])
    joint_range["Head"][2] = np.array([-np.pi, np.pi])

    joint_range["Chest"][0] = np.array([-np.pi, np.pi])
    joint_range["Chest"][1] = np.array([-np.pi, np.pi])
    joint_range["Chest"][2] = np.array([-np.pi, np.pi])

    joint_range["Spine"][0] = np.array([-np.pi, np.pi])
    joint_range["Spine"][1] = np.array([-np.pi, np.pi])
    joint_range["Spine"][2] = np.array([-np.pi, np.pi])

    joint_range["Torso"][0] = np.array([-np.pi, np.pi])
    joint_range["Torso"][1] = np.array([-np.pi, np.pi])
    joint_range["Torso"][2] = np.array([-np.pi, np.pi])
    ...
    joint_range["L_Hip"][0] = np.array([-np.pi, np.pi])
    joint_range["L_Hip"][1] = np.array([-np.pi, np.pi])
    joint_range["L_Hip"][2] = np.array([-np.pi, np.pi])

    joint_range["R_Hip"][0] = np.array([-np.pi, np.pi])
    joint_range["R_Hip"][1] = np.array([-np.pi, np.pi])
    joint_range["R_Hip"][2] = np.array([-np.pi, np.pi])

    joint_range["L_Knee"][0] = np.array([-np.pi, np.pi])
    joint_range["L_Knee"][1] = np.array([-np.pi, np.pi])
    joint_range["L_Knee"][2] = np.array([-np.pi, np.pi])

    joint_range["R_Knee"][0] = np.array([-np.pi, np.pi])
    joint_range["R_Knee"][1] = np.array([-np.pi, np.pi])
    joint_range["R_Knee"][2] = np.array([-np.pi, np.pi])

    joint_range["L_Ankle"][0] = np.array([-np.pi, np.pi])
    joint_range["L_Ankle"][1] = np.array([-np.pi, np.pi])
    joint_range["L_Ankle"][2] = np.array([-np.pi, np.pi])

    joint_range["R_Ankle"][0] = np.array([-np.pi, np.pi])
    joint_range["R_Ankle"][1] = np.array([-np.pi, np.pi])
    joint_range["R_Ankle"][2] = np.array([-np.pi, np.pi])

    joint_range["L_Toe"][0] = np.array([-np.pi, np.pi])
    joint_range["L_Toe"][1] = np.array([-np.pi, np.pi])
    joint_range["L_Toe"][2] = np.array([-np.pi, np.pi])

    joint_range["R_Toe"][0] = np.array([-np.pi, np.pi])
    joint_range["R_Toe"][1] = np.array([-np.pi, np.pi])
    joint_range["R_Toe"][2] = np.array([-np.pi, np.pi])
    return joint_range
...
def update_joint_limits_upright(joint_range):
    ...
    joint_range["R_Elbow"][0] = np.array([-np.pi, np.pi])
    joint_range["R_Elbow"][1] = np.array([-np.pi, np.pi])
    joint_range["R_Elbow"][2] = np.array([-np.pi, np.pi])

    joint_range["R_Index1"][0] = np.array([-np.pi, np.pi])
    joint_range["R_Index1"][1] = np.array([-np.pi, np.pi])
    joint_range["R_Index1"][2] = np.array([-np.pi, np.pi])

    joint_range["R_Index2"][0] = np.array([-np.pi, np.pi])
    joint_range["R_Index2"][1] = np.array([-np.pi, np.pi])
    joint_range["R_Index2"][2] = np.array([-np.pi, np.pi])

    joint_range["R_Index3"][0] = np.array([-np.pi, np.pi])
    joint_range["R_Index3"][1] = np.array([-np.pi, np.pi])
    joint_range["R_Index3"][2] = np.array([-np.pi, np.pi])

    joint_range["R_Middle1"][0] = np.array([-np.pi, np.pi])
    joint_range["R_Middle1"][1] = np.array([-np.pi, np.pi])
    joint_range["R_Middle1"][2] = np.array([-np.pi, np.pi])

    joint_range["R_Middle2"][0] = np.array([-np.pi, np.pi])
    joint_range["R_Middle2"][1] = np.array([-np.pi, np.pi])
    joint_range["R_Middle2"][2] = np.array([-np.pi, np.pi])

    joint_range["R_Middle3"][0] = np.array([-np.pi, np.pi])
    joint_range["R_Middle3"][1] = np.array([-np.pi, np.pi])
    joint_range["R_Middle3"][2] = np.array([-np.pi, np.pi])

    joint_range["R_Pinky1"][0] = np.array([-np.pi, np.pi])
    joint_range["R_Pinky1"][1] = np.array([-np.pi, np.pi])
    joint_range["R_Pinky1"][2] = np.array([-np.pi, np.pi])

    joint_range["R_Pinky2"][0] = np.array([-np.pi, np.pi])
    joint_range["R_Pinky2"][1] = np.array([-np.pi, np.pi])
    joint_range["R_Pinky2"][2] = np.array([-np.pi, np.pi])

    joint_range["R_Pinky3"][0] = np.array([-np.pi, np.pi])
    joint_range["R_Pinky3"][1] = np.array([-np.pi, np.pi])
    joint_range["R_Pinky3"][2] = np.array([-np.pi, np.pi])

    joint_range["R_Ring1"][0] = np.array([-np.pi, np.pi])
    joint_range["R_Ring1"][1] = np.array([-np.pi, np.pi])
    joint_range["R_Ring1"][2] = np.array([-np.pi, np.pi])

    joint_range["R_Ring2"][0] = np.array([-np.pi, np.pi])
    joint_range["R_Ring2"][1] = np.array([-np.pi, np.pi])
    joint_range["R_Ring2"][2] = np.array([-np.pi, np.pi])

    joint_range["R_Ring3"][0] = np.array([-np.pi, np.pi])
    joint_range["R_Ring3"][1] = np.array([-np.pi, np.pi])
    joint_range["R_Ring3"][2] = np.array([-np.pi, np.pi])

    joint_range["R_Thumb1"][0] = np.array([-np.pi, np.pi])
    joint_range["R_Thumb1"][1] = np.array([-np.pi, np.pi])
    joint_range["R_Thumb1"][2] = np.array([-np.pi, np.pi])

    joint_range["R_Thumb2"][0] = np.array([-np.pi, np.pi])
    joint_range["R_Thumb2"][1] = np.array([-np.pi, np.pi])
    joint_range["R_Thumb2"][2] = np.array([-np.pi, np.pi])

    joint_range["R_Thumb3"][0] = np.array([-np.pi, np.pi])
    joint_range["R_Thumb3"][1] = np.array([-np.pi, np.pi])
    joint_range["R_Thumb3"][2] = np.array([-np.pi, np.pi])

    joint_range["L_Elbow"][0] = np.array([-np.pi, np.pi])
    joint_range["L_Elbow"][1] = np.array([-np.pi, np.pi])
    joint_range["L_Elbow"][2] = np.array([-np.pi, np.pi])

    joint_range["L_Index1"][0] = np.array([-np.pi, np.pi])
    joint_range["L_Index1"][1] = np.array([-np.pi, np.pi])
    joint_range["L_Index1"][2] = np.array([-np.pi, np.pi])

    joint_range["L_Index2"][0] = np.array([-np.pi, np.pi])
    joint_range["L_Index2"][1] = np.array([-np.pi, np.pi])
    joint_range["L_Index2"][2] = np.array([-np.pi, np.pi])

    joint_range["L_Index3"][0] = np.array([-np.pi, np.pi])
    joint_range["L_Index3"][1] = np.array([-np.pi, np.pi])
    joint_range["L_Index3"][2] = np.array([-np.pi, np.pi])

    joint_range["L_Middle1"][0] = np.array([-np.pi, np.pi])
    joint_range["L_Middle1"][1] = np.array([-np.pi, np.pi])
    joint_range["L_Middle1"][2] = np.array([-np.pi, np.pi])

    joint_range["L_Middle2"][0] = np.array([-np.pi, np.pi])
    joint_range["L_Middle2"][1] = np.array([-np.pi, np.pi])
    joint_range["L_Middle2"][2] = np.array([-np.pi, np.pi])

    joint_range["L_Middle3"][0] = np.array([-np.pi, np.pi])
    joint_range["L_Middle3"][1] = np.array([-np.pi, np.pi])
    joint_range["L_Middle3"][2] = np.array([-np.pi, np.pi])

    joint_range["L_Pinky1"][0] = np.array([-np.pi, np.pi])
    joint_range["L_Pinky1"][1] = np.array([-np.pi, np.pi])
    joint_range["L_Pinky1"][2] = np.array([-np.pi, np.pi])

    joint_range["L_Pinky2"][0] = np.array([-np.pi, np.pi])
    joint_range["L_Pinky2"][1] = np.array([-np.pi, np.pi])
    joint_range["L_Pinky2"][2] = np.array([-np.pi, np.pi])

    joint_range["L_Pinky3"][0] = np.array([-np.pi, np.pi])
    joint_range["L_Pinky3"][1] = np.array([-np.pi, np.pi])
    joint_range["L_Pinky3"][2] = np.array([-np.pi, np.pi])

    joint_range["L_Ring1"][0] = np.array([-np.pi, np.pi])
    joint_range["L_Ring1"][1] = np.array([-np.pi, np.pi])
    joint_range["L_Ring1"][2] = np.array([-np.pi, np.pi])

    joint_range["L_Ring2"][0] = np.array([-np.pi, np.pi])
    joint_range["L_Ring2"][1] = np.array([-np.pi, np.pi])
    joint_range["L_Ring2"][2] = np.array([-np.pi, np.pi])

    joint_range["L_Ring3"][0] = np.array([-np.pi, np.pi])
    joint_range["L_Ring3"][1] = np.array([-np.pi, np.pi])
    joint_range["L_Ring3"][2] = np.array([-np.pi, np.pi])

    joint_range["L_Thumb1"][0] = np.array([-np.pi, np.pi])
    joint_range["L_Thumb1"][1] = np.array([-np.pi, np.pi])
    joint_range["L_Thumb1"][2] = np.array([-np.pi, np.pi])

    joint_range["L_Thumb2"][0] = np.array([-np.pi, np.pi])
    joint_range["L_Thumb2"][1] = np.array([-np.pi, np.pi])
    joint_range["L_Thumb2"][2] = np.array([-np.pi, np.pi])

    joint_range["L_Thumb3"][0] = np.array([-np.pi, np.pi])
    joint_range["L_Thumb3"][1] = np.array([-np.pi, np.pi])
    joint_range["L_Thumb3"][2] = np.array([-np.pi, np.pi])
    ...
    joint_range["Neck"][0] = np.array([-np.pi, np.pi])
    joint_range["Neck"][1] = np.array([-np.pi, np.pi])
    joint_range["Neck"][2] = np.array([-np.pi, np.pi])
...
class SMPL_Robot:
    def __init__(self, cfg, data_dir="data/smpl", sbj_vtemp=None):
        self.bodies = []
        self.weight = 0
        self.height = 0
        self.cfg = cfg
        ...
        self.flat_hand_mean = cfg.get("flat_hand_mean", False)
        ...
        self.beta = (torch.zeros(
            (1, 10)).float() if self.smpl_model == "smpl" or (self.smpl_model == "smplh" and self.gender != "neutral") else torch.zeros(
                (1, 16)).float()) if cfg.get("beta", None) is None else torch.from_numpy(cfg.get("beta", None)[None, :])


        self.sbj_vtemp = sbj_vtemp
        ...
        if self.gender == "neutral":
            ...
            gender_number = [2]
        self.load_from_skeleton(gender=gender_number, sbj_vtemp=self.sbj_vtemp)
        ...
        if self.mesh:
            ...
            (
                ...
                zero_pose=zero_pose, betas=self.beta, flatfoot=self.flatfoot)
                 ...
                 smpl_parser.get_mesh_offsets(sbj_vtemp=sbj_vtemp, smpl_model=smpl_model))
            ...
            self.hull_dict = get_joint_geometries(
                ...
                geom_dir=os.path.join(self.model_dirs[-1],"geom"),
            )
            ...
            verts, joints, skin_weights, joint_names, joint_offsets, parents_dict, channels, joint_range = smpl_parser.get_offsets(
                betas=self.beta, zero_pose=zero_pose, sbj_vtemp=sbj_vtemp, smpl_model=smpl_model)

            print(joint_names, joints.shape, skin_weights.shape)
