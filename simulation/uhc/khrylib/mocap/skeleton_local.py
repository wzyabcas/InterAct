...
GAINS = {
    ...
    "L_Wrist": [300, 30, 1, 150],
    # "L_Hand": [300, 30, 1, 150],
    'L_Index1': [100, 10, 1, 50],
    'L_Index2': [100, 10, 1, 50],
    'L_Index3': [100, 10, 1, 50],
    'L_Middle1': [100, 10, 1, 50],
    'L_Middle2': [100, 10, 1, 50],
    'L_Middle3': [100, 10, 1, 50],
    'L_Pinky1': [100, 10, 1, 50],
    'L_Pinky2': [100, 10, 1, 50],
    'L_Pinky3': [100, 10, 1, 50],
    'L_Ring1': [100, 10, 1, 50],
    'L_Ring2': [100, 10, 1, 50],
    'L_Ring3': [100, 10, 1, 50],
    'L_Thumb1': [100, 10, 1, 50],
    'L_Thumb2': [100, 10, 1, 50],
    'L_Thumb3': [100, 10, 1, 50],
    "R_Thorax": [500, 50, 1, 150],
    "R_Shoulder": [500, 50, 1, 250],
    "R_Elbow": [500, 50, 1, 150],
    "R_Wrist": [300, 30, 1, 150],
    # "R_Hand": [300, 30, 1, 150],
    'R_Index1': [100, 10, 1, 50],
    'R_Index2': [100, 10, 1, 50],
    'R_Index3': [100, 10, 1, 50],
    'R_Middle1': [100, 10, 1, 50],
    'R_Middle2': [100, 10, 1, 50],
    'R_Middle3': [100, 10, 1, 50],
    'R_Pinky1': [100, 10, 1, 50],
    'R_Pinky2': [100, 10, 1, 50],
    'R_Pinky3': [100, 10, 1, 50],
    'R_Ring1': [100, 10, 1, 50],
    'R_Ring2': [100, 10, 1, 50],
    'R_Ring3': [100, 10, 1, 50],
    'R_Thumb1': [100, 10, 1, 50],
    'R_Thumb2': [100, 10, 1, 50],
    'R_Thumb3': [100, 10, 1, 50],
}
...
class Skeleton:
    ...
    def __init__(self, smpl_model = "smplh"):
        self.bones = []
        self.name2bone = {}
        self.mass_scale = 1.0
        self.len_scale = 1.0
    ...
    def write_xml_bodynode(self, bone, parent_node, offset, ref_angles):
        ...
        if bone.parent is None:
            ...
            if self.ball_joints:
                ...
                for i in range(len(bone.dof_index)):
                    ...
                    j_attr["type"] = "hinge"
                    j_attr["pos"] = "{0:.4f} {1:.4f} {2:.4f}".format(*(bone.pos + offset))
                    # print(j_attr["name"], j_attr["pos"], offset)
                    ...
                    if i < len(bone.lb):
                        ...
                        j_attr["range"] = "-180.0000 180.0000"
                    if j_attr["name"] in ref_angles.keys():
                        j_attr["ref"] = f"{ref_angles[j_attr['name']]:.1f}"
        ...
        # if bone.name in ["L_Shoulder", "R_Shoulder"]:
        #     seperation = 0.
        ...
        if g_attr["type"] == "capsule":
            ...
            if bone.name in ["Pelvis"]:
                g_attr["density"] = str(4629.6296296296305)

            if bone.name in ["L_Hip", "R_Hip"]:
                g_attr["density"] = str(2040.816327)

            if bone.name in ["L_Knee", 'R_Knee', "Torso", "Spine", "Chest"]:
                g_attr["density"] = str(1234.567901)
            ...
            if (bone.name == "L_Wrist" or bone.name == "R_Wrist"):
                if self.upright_start:
